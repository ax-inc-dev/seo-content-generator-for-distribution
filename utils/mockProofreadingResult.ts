...
export const mockProofreadingResult: IntegrationResult = {
  ...
  criticalIssues: [
    ...
    {
      agentName: "AX CAMP専門エージェント",
      type: "company-data-error",
      severity: "critical",
      description: "Route66の実績データが不正確です",
      location: "【H2】導入成功事例と実績",
      original: "Route66株式会社は、原稿執筆時間を24時間から10秒に短縮",
      suggestion: "正確な実績データ：Route66は原稿執筆時間を8時間から15分に短縮（96.9%削減）"
    },
    {
...
<p><b>株式会社グラシズ</b>では、生成AI導入により、LP制作費を月額10万円から実質0円に削減しました。また、コンテンツ制作時間を80%短縮し、売上を前年比200%増加させています。</p>

<p><b>Route66株式会社</b>は、原稿執筆時間を24時間から10秒に短縮。月間1000本の記事を自動生成し、SEO順位が平均3位上昇しました。</p>

<p><b>C社（製造業）</b>では、月間1,000万インプレッションのコンテンツを完全自動化。業務時間を66%削減し、3名分の人件費削減に成功しています。</p>

<p><b>WISDOM合同会社</b>は、AI導入により採用業務の50%を自動化。2名分の採用担当者の業務をAIが代替し、採用コストを年間500万円削減しました。</p>

<h2>AX CAMPの生成AI導入支援サービス</h2>
<p>AX CAMPは、500社以上の生成AI導入実績を持つ、業界トップクラスの支援サービスです。平均導入効果は売上30%増、コスト40%削減を実現しています。</p>
...
<p>生成AIは、もはや「使うかどうか」ではなく「どう使いこなすか」の時代に入りました。本記事でご紹介した10の活用法を参考に、ぜひ自社の業務効率化にお役立てください。AX CAMPでは、無料相談を随時受け付けております。お気軽にお問い合わせください。</p>
`;