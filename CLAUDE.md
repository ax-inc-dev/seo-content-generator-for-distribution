...
- CSVファイル: 
  ...
  - `video_segments.csv`（動画データ・AI秘書の作り方含む）
- 実績企業例：
  - グラシズ: LP制作費10万円→0円
  - Route66: 原稿執筆24時間→10秒
  - C社: 月1,000万imp自動化、業務時間66%削減
  - WISDOM: AI導入で採用2名分の業務をAI代替

### 実績データの使い方
- 成功事例セクションで具体的数値を引用
- AX CAMP訴求セクションで成果を強調
- 企業名と業界を正確に記載
- AI秘書の作り方など、動画コンテンツも活用可能
...
#### ❌ 避けるべき対処療法的アプローチ
1. **特定データのハードコード**
   - 例：「WISDOMの実績が取れない」→「WISDOMの情報を直接コードに追加」
...
### 成果
- ✅ AI秘書の作り方の詳細な文字起こしデータ取得成功
- ✅ 全実績企業データの取得確認（グラシズ、Route66、WISDOM、C社）
- ✅ 認証の自動化と安定性向上
...
#### 5. AX CAMP専門エージェント
**役割**: AX CAMP関連情報の正確性と一貫性を確保
- **使用モデル**: gpt-5-nano
- **処理内容**:
  - AX CAMP実績データの正確性（グラシズ、Route66等）
  - サービス内容の最新性
  - 料金・プラン情報の確認
  - 自社情報の一貫性確保
- **推定処理時間**: 2-3秒
